const sections = [
  { title: 'Information We Collect', content: 'We collect information you provide directly, such as your name, email address, and payment information when you create an account. We also collect usage data including dataset submissions, review interactions, and device information to improve our services.' },
  { title: 'How We Use Your Information', content: 'We use your information to provide, maintain, and improve our services; process payments; send communications; detect and prevent fraud; and comply with legal obligations. We do not sell your datasets to third parties.' },
  ...
  { title: 'Data Retention', content: 'We retain your account information for as long as your account is active. Submission history is retained for quality and payment records. You may request deletion of your data at any time by contacting support@loseyourip.com.' },
